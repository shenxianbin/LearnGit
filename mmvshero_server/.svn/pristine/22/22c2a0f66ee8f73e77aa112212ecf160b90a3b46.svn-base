...
type RoleCache struct {
	...
	KingSkills           map[int32]*KingSkill `protobuf:"bytes,9,rep,name=king_skills" json:"king_skills,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	ChatRefreshTimestamp *int64               `protobuf:"varint,12,req,name=chat_refresh_timestamp" json:"chat_refresh_timestamp,omitempty"`
	NewPlayerGuideStep   *int32               `protobuf:"varint,13,req,name=new_player_guide_step" json:"new_player_guide_step,omitempty"`
	LoginTime            *int64               `protobuf:"varint,14,req,name=loginTime" json:"loginTime,omitempty"`
	GuidePlunderAward    *bool                `protobuf:"varint,15,opt,name=guide_plunder_award" json:"guide_plunder_award,omitempty"`
	RechargeRecord       map[int32]int32      `protobuf:"bytes,16,rep,name=recharge_record" json:"recharge_record,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	XXX_unrecognized     []byte               `json:"-"`
}
...
func (m *RoleCache) GetRechargeRecord() map[int32]int32 {
	if m != nil {
...
func (m *RoleCache) SetRechargeRecord(value map[int32]int32) {
	if m != nil {
		m.RechargeRecord = value
	}
}
