...
const (
	GmMsgCode_GmCommandNotify GmMsgCode = 1001
	GmMsgCode_GmLanternNotify GmMsgCode = 1002
)

var GmMsgCode_name = map[int32]string{
	1001: "GmCommandNotify",
	1002: "GmLanternNotify",
}
...
type MsgGmLanternNotify struct {
...
func (m *MsgGmLanternNotify) Reset()         { *m = MsgGmLanternNotify{} }
func (m *MsgGmLanternNotify) String() string { return proto.CompactTextString(m) }
func (*MsgGmLanternNotify) ProtoMessage()    {}

func (m *MsgGmLanternNotify) GetType() int32 {
	if m != nil && m.Type != nil {
		return *m.Type
	}
	return 0
...
func (m *MsgGmLanternNotify) GetId() int32 {
	if m != nil && m.Id != nil {
		return *m.Id
	}
	return 0
...
func (m *MsgGmLanternNotify) GetTime() int64 {
	if m != nil && m.Time != nil {
		return *m.Time
	}
	return 0
...
func (m *MsgGmLanternNotify) GetContent() []byte {
	if m != nil {
		return m.Content
	}
	return nil
...
func (m *MsgGmLanternNotify) SetType(value int32) {
	if m != nil {
		if m.Type != nil {
			*m.Type = value
			return
...
func (m *MsgGmLanternNotify) SetId(value int32) {
	if m != nil {
		if m.Id != nil {
			*m.Id = value
			return
...
func (m *MsgGmLanternNotify) SetTime(value int64) {
	if m != nil {
		if m.Time != nil {
			*m.Time = value
			return
...
func (m *MsgGmLanternNotify) SetContent(value []byte) {
	if m != nil {
		if m.Content != nil {
			m.Content = value
			return
