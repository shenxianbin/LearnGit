...
type PlunderHeroCache struct {
	...
	SkillList        map[int32]*PlunderHeroSkillCache `protobuf:"bytes,5,rep,name=skill_list" json:"skill_list,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *PlunderReportCache) GetExData() int64 {
...
func (m *PlunderReportCache) SetExData(value int64) {
	if m != nil {
		if m.ExData != nil {
			*m.ExData = value
			return
...
type PlunderCache struct {
	...
	PurchasedTimes         *int32                 `protobuf:"varint,6,req,name=purchased_times" json:"purchased_times,omitempty"`
	CurrentMatchRoleUid    *int64                 `protobuf:"varint,7,req,name=current_match_role_uid" json:"current_match_role_uid,omitempty"`
	CurrentMatchTeamId     *int64                 `protobuf:"varint,8,req,name=current_match_team_id" json:"current_match_team_id,omitempty"`
	CurrentMatchIsRevenge  *bool                  `protobuf:"varint,9,req,name=current_match_is_revenge" json:"current_match_is_revenge,omitempty"`
	CurrentMatchExpireTime *int64                 `protobuf:"varint,10,req,name=current_match_expire_time" json:"current_match_expire_time,omitempty"`
	ReportId               *int64                 `protobuf:"varint,11,req,name=report_id" json:"report_id,omitempty"`
	XXX_unrecognized       []byte                 `json:"-"`
}
...
func (m *PlunderCache) GetPurchasedTimes() int32 {
...
func (m *PlunderCache) GetCurrentMatchRoleUid() int64 {
	if m != nil && m.CurrentMatchRoleUid != nil {
		return *m.CurrentMatchRoleUid
	}
	return 0
}

func (m *PlunderCache) GetCurrentMatchTeamId() int64 {
	if m != nil && m.CurrentMatchTeamId != nil {
		return *m.CurrentMatchTeamId
	}
	return 0
}

func (m *PlunderCache) GetCurrentMatchIsRevenge() bool {
	if m != nil && m.CurrentMatchIsRevenge != nil {
		return *m.CurrentMatchIsRevenge
	}
	return false
}

func (m *PlunderCache) GetCurrentMatchExpireTime() int64 {
	if m != nil && m.CurrentMatchExpireTime != nil {
		return *m.CurrentMatchExpireTime
	}
	return 0
}

func (m *PlunderCache) GetReportId() int64 {
	if m != nil && m.ReportId != nil {
		return *m.ReportId
	}
	return 0
...
func (m *PlunderCache) SetPurchasedTimes(value int32) {
	if m != nil {
...
func (m *PlunderCache) SetCurrentMatchRoleUid(value int64) {
	if m != nil {
		if m.CurrentMatchRoleUid != nil {
			*m.CurrentMatchRoleUid = value
			return
		}
		m.CurrentMatchRoleUid = proto.Int64(value)
	}
}

func (m *PlunderCache) SetCurrentMatchTeamId(value int64) {
	if m != nil {
		if m.CurrentMatchTeamId != nil {
			*m.CurrentMatchTeamId = value
			return
		}
		m.CurrentMatchTeamId = proto.Int64(value)
	}
}

func (m *PlunderCache) SetCurrentMatchIsRevenge(value bool) {
	if m != nil {
		if m.CurrentMatchIsRevenge != nil {
			*m.CurrentMatchIsRevenge = value
			return
		}
		m.CurrentMatchIsRevenge = proto.Bool(value)
	}
}

func (m *PlunderCache) SetCurrentMatchExpireTime(value int64) {
	if m != nil {
		if m.CurrentMatchExpireTime != nil {
			*m.CurrentMatchExpireTime = value
			return
		}
		m.CurrentMatchExpireTime = proto.Int64(value)
	}
}

func (m *PlunderCache) SetReportId(value int64) {
	if m != nil {
		if m.ReportId != nil {
			*m.ReportId = value
			return
...
type PlunderPoolNodeCache struct {
	RoleUid          *int64 `protobuf:"varint,1,req,name=roleUid" json:"roleUid,omitempty"`
	...
	SearchLock       *int64 `protobuf:"varint,5,opt,name=searchLock" json:"searchLock,omitempty"`
	BattleLock       *int64 `protobuf:"varint,6,opt,name=battleLock" json:"battleLock,omitempty"`
	PostWarLock      *int64 `protobuf:"varint,7,opt,name=postWarLock" json:"postWarLock,omitempty"`
	AttackerId       *int64 `protobuf:"varint,8,opt,name=attackerId" json:"attackerId,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *PlunderPoolNodeCache) Reset()         { *m = PlunderPoolNodeCache{} }
func (m *PlunderPoolNodeCache) String() string { return proto.CompactTextString(m) }
func (*PlunderPoolNodeCache) ProtoMessage()    {}

func (m *PlunderPoolNodeCache) GetRoleUid() int64 {
	if m != nil && m.RoleUid != nil {
		return *m.RoleUid
	}
	return 0
...
func (m *PlunderPoolNodeCache) GetTeamId() int64 {
	if m != nil && m.TeamId != nil {
		return *m.TeamId
	}
	return 0
...
func (m *PlunderPoolNodeCache) GetEndTime() int64 {
...
func (m *PlunderPoolNodeCache) GetScore() int64 {
...
func (m *PlunderPoolNodeCache) GetSearchLock() int64 {
	if m != nil && m.SearchLock != nil {
		return *m.SearchLock
	}
	return 0
}

func (m *PlunderPoolNodeCache) GetBattleLock() int64 {
	if m != nil && m.BattleLock != nil {
		return *m.BattleLock
	}
	return 0
}

func (m *PlunderPoolNodeCache) GetPostWarLock() int64 {
	if m != nil && m.PostWarLock != nil {
		return *m.PostWarLock
	}
	return 0
}

func (m *PlunderPoolNodeCache) GetAttackerId() int64 {
...
func (m *PlunderPoolNodeCache) SetRoleUid(value int64) {
	if m != nil {
		if m.RoleUid != nil {
			*m.RoleUid = value
			return
...
func (m *PlunderPoolNodeCache) SetTeamId(value int64) {
	if m != nil {
		if m.TeamId != nil {
			*m.TeamId = value
			return
...
func (m *PlunderPoolNodeCache) SetEndTime(value int64) {
	if m != nil {
		if m.EndTime != nil {
			*m.EndTime = value
			return
...
func (m *PlunderPoolNodeCache) SetScore(value int64) {
	if m != nil {
		if m.Score != nil {
			*m.Score = value
			return
		}
		m.Score = proto.Int64(value)
	}
}

func (m *PlunderPoolNodeCache) SetSearchLock(value int64) {
	if m != nil {
		if m.SearchLock != nil {
			*m.SearchLock = value
			return
		}
		m.SearchLock = proto.Int64(value)
	}
}

func (m *PlunderPoolNodeCache) SetBattleLock(value int64) {
	if m != nil {
		if m.BattleLock != nil {
			*m.BattleLock = value
			return
		}
		m.BattleLock = proto.Int64(value)
	}
}

func (m *PlunderPoolNodeCache) SetPostWarLock(value int64) {
	if m != nil {
		if m.PostWarLock != nil {
			*m.PostWarLock = value
			return
		}
		m.PostWarLock = proto.Int64(value)
	}
}

func (m *PlunderPoolNodeCache) SetAttackerId(value int64) {
	if m != nil {
		if m.AttackerId != nil {
			*m.AttackerId = value
			return
		}
		m.AttackerId = proto.Int64(value)
	}
}
