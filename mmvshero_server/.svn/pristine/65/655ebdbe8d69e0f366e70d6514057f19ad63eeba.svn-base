...
type StageCache struct {
	...
	Stars             map[string]int32 `protobuf:"bytes,5,rep,name=stars" json:"stars,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
func (m *StageCache) GetStars() map[string]int32 {
	if m != nil {
		return m.Stars
	}
	return nil
...
func (m *StageCache) GetLastBattleTime() int64 {
...
func (m *StageCache) GetDailyBattleTimes() int32 {
...
func (m *StageCache) GetPurchasedTimes() int32 {
...
func (m *StageCache) SetStars(value map[string]int32) {
	if m != nil {
		m.Stars = value
	}
}

func (m *StageCache) SetLastBattleTime(value int64) {
	if m != nil {
...
func (m *StageCache) SetDailyBattleTimes(value int32) {
	if m != nil {
...
func (m *StageCache) SetPurchasedTimes(value int32) {
	if m != nil {
