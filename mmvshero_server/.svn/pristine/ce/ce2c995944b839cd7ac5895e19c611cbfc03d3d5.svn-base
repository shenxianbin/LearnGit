...
func (this *BuildingSys) BuildingObtain(scheme_id int32, lv int32, is_notify bool) int64 {
...
func (this *BuildingSys) BuildingStartLvUp(building_uid int64, usedCoin bool, is_notify bool) common.RetCode {
	...
	if scheme_buildingLvup == nil {
		LogError("common.RetCode_SchemeData_Error")
		return common.RetCode_SchemeData_Error
	}

	if this.owner.GetKingLv() < building.GetLvUpKingLv() {
		LogDebug("KingLv < LvUpKingLv", this.owner.GetKingLv(), building.GetLvUpKingLv())
		return common.RetCode_Unable
	}
	...
	//魔血魔魂
	if !this.owner.IsEnoughBlood(building.GetLvUpBlood()) || !this.owner.IsEnoughSoul(building.GetLvUpSoul()) {
		LogDebug("!this.owner.IsEnoughBlood(building.GetLvUpBlood()):", !this.owner.IsEnoughBlood(building.GetLvUpBlood()), building.GetLvUpBlood())
		LogDebug("!this.owner.IsEnoughSoul(building.GetLvUpSoul()):", !this.owner.IsEnoughSoul(building.GetLvUpSoul()), building.GetLvUpSoul())
		return common.RetCode_Unable
	}
