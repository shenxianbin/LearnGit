...
func (this *Role) FillRoleBaseInfo() *protocol.RoleBaseInfo {
	...
	msg.SetOrderBuynum(this.RoleCache.GetOrderBuynum())
	msg.SetOrderTimestamp(this.RoleCache.GetOrderTimestamp())
	msg.SetSpirit(this.RoleCache.GetSpirit())
	msg.SetSpiritBuynum(this.RoleCache.GetSpiritBuynum())
...
func (this *Role) EditOrder(value int32, is_notify bool, is_save bool) {
	...
	this.RoleCache.SetOrderTimestamp(time.Now().Unix())
...
func (this *Role) AddOrderBuynum(is_notify bool, is_save bool) {
	this.RoleCache.SetOrderBuynum(this.RoleCache.GetOrderBuynum() + 1)

	if is_notify {
		this.send_updateinfo(protocol.RoleAttrType_Order_Buynum, int64(this.RoleCache.GetOrderBuynum()))
	}
...
func (this *Role) ResetOrderBuynum(is_notify bool, is_save bool) {
	this.RoleCache.SetOrderBuynum(0)
...
func (this *Role) EditSpirit(value int32, is_notify bool, is_save bool) {
	...
	this.RoleCache.SetSpiritTimestamp(time.Now().Unix())
...
func (this *Role) AddSpiritBuynum(is_notify bool, is_save bool) {
	this.RoleCache.SetSpiritBuynum(this.RoleCache.GetSpiritBuynum() + 1)

	if is_notify {
		this.send_updateinfo(protocol.RoleAttrType_Spirit_Buynum, int64(this.RoleCache.GetSpiritBuynum()))
	}
...
func (this *Role) ResetSpiritBuynum(is_notify bool, is_save bool) {
	this.RoleCache.SetSpiritBuynum(0)
