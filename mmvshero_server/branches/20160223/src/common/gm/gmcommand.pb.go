...
const (
	...
	CommandModule_King     CommandModule = 1
	CommandModule_Item     CommandModule = 2
	CommandModule_Hero     CommandModule = 3
	CommandModule_Soldier  CommandModule = 4
	CommandModule_Building CommandModule = 5
)
...
const (
	...
	CommandOption_Spirit   CommandOption = 3
	CommandOption_Soul     CommandOption = 4
	CommandOption_Blood    CommandOption = 5
	CommandOption_Stone    CommandOption = 6
	CommandOption_Gold     CommandOption = 7
	CommandOption_FreeGold CommandOption = 8
	CommandOption_SkillLv  CommandOption = 9
	CommandOption_Num      CommandOption = 10
	CommandOption_Stage    CommandOption = 11
	CommandOption_Rank     CommandOption = 12
)
