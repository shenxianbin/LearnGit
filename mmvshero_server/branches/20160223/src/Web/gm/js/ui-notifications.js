(function() {
    ...
    a = jQuery,
        ...
        b = function(b) {
            ...
            return e(d, b),
                d.prototype.template = function(b) {
                    var e;
                    return e = d.__super__.template.apply(this, arguments),
                        e.append(a(c)),
                        e
                },
                d
    ...
    $(function() {
        function a() {
            ...
            var b = ["bottom", "right"],
                c = $(".location-selector"),
                d = function() {
                    for (var c = "messenger-fixed",
                             d = 0; d < b.length; d++) c += " messenger-on-" + b[d];
                    $.globalMessenger({
                        extraClasses: c,
                        theme: a
                    }),
