...
type ReceiveExcitationCache struct {
...
func (m *ReceiveExcitationCache) Reset()         { *m = ReceiveExcitationCache{} }
func (m *ReceiveExcitationCache) String() string { return proto.CompactTextString(m) }
func (*ReceiveExcitationCache) ProtoMessage()    {}

func (m *ReceiveExcitationCache) GetTimes() int32 {
...
func (m *ReceiveExcitationCache) GetTimestamp() int64 {
	if m != nil && m.Timestamp != nil {
		return *m.Timestamp
	}
	return 0
...
func (m *ReceiveExcitationCache) SetTimes(value int32) {
	if m != nil {
		if m.Times != nil {
			*m.Times = value
			return
...
func (m *ReceiveExcitationCache) SetTimestamp(value int64) {
	if m != nil {
		if m.Timestamp != nil {
			*m.Timestamp = value
			return
