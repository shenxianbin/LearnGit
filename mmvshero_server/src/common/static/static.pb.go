...
const (
	...
	PayType_bloodExchagePvp    PayType = 1
	PayType_bloodBuyMappoint   PayType = 2
	PayType_bloodBuyDecoration PayType = 3
	PayType_soulBuyMappoint    PayType = 4
	PayType_soulBuyDecoration  PayType = 5
	PayType_evolutionSpeedup   PayType = 6
	PayType_evolutionOnekey    PayType = 7
	PayType_upBuildingSpeedup  PayType = 8
	PayType_upBuildingOnekey   PayType = 9
	PayType_upKingskillSpeedup PayType = 10
	PayType_upKingskillOnekey  PayType = 11
)
...
var PayType_name = map[int32]string{
	...
	8:  "upBuildingSpeedup",
	9:  "upBuildingOnekey",
	10: "upKingskillSpeedup",
	11: "upKingskillOnekey",
}
