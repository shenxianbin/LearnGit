...
type MsgItemSellReq struct {
	Uid              *int64 `protobuf:"varint,1,req,name=uid" json:"uid,omitempty"`
	Num              *int32 `protobuf:"varint,2,req,name=num" json:"num,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MsgItemSellReq) Reset()         { *m = MsgItemSellReq{} }
func (m *MsgItemSellReq) String() string { return proto.CompactTextString(m) }
func (*MsgItemSellReq) ProtoMessage()    {}

func (m *MsgItemSellReq) GetUid() int64 {
	if m != nil && m.Uid != nil {
		return *m.Uid
	}
	return 0
...
func (m *MsgItemSellReq) GetNum() int32 {
	if m != nil && m.Num != nil {
		return *m.Num
	}
	return 0
...
func (m *MsgItemSellReq) SetUid(value int64) {
	if m != nil {
		if m.Uid != nil {
			*m.Uid = value
			return
...
func (m *MsgItemSellReq) SetNum(value int32) {
	if m != nil {
		if m.Num != nil {
			*m.Num = value
			return
...
type MsgItemSellRet struct {
	Retcode          *int32 `protobuf:"varint,1,req,name=retcode" json:"retcode,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MsgItemSellRet) Reset()         { *m = MsgItemSellRet{} }
func (m *MsgItemSellRet) String() string { return proto.CompactTextString(m) }
func (*MsgItemSellRet) ProtoMessage()    {}

func (m *MsgItemSellRet) GetRetcode() int32 {
	if m != nil && m.Retcode != nil {
		return *m.Retcode
	}
	return 0
...
func (m *MsgItemSellRet) SetRetcode(value int32) {
	if m != nil {
		if m.Retcode != nil {
			*m.Retcode = value
			return
