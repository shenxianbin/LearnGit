...
type MallInfo struct {
	...
	LimitCount       *int32 `protobuf:"varint,2,req,name=limit_count" json:"limit_count,omitempty"`
	Cd               *int64 `protobuf:"varint,3,req,name=cd" json:"cd,omitempty"`
	ConArgs          *int32 `protobuf:"varint,4,req,name=con_args" json:"con_args,omitempty"`
...
type MsgMallGoldFillReq struct {
	Soul             *int32 `protobuf:"varint,2,req,name=soul" json:"soul,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MsgMallGoldFillReq) Reset()         { *m = MsgMallGoldFillReq{} }
func (m *MsgMallGoldFillReq) String() string { return proto.CompactTextString(m) }
func (*MsgMallGoldFillReq) ProtoMessage()    {}

func (m *MsgMallGoldFillReq) GetSoul() int32 {
	if m != nil && m.Soul != nil {
		return *m.Soul
	}
	return 0
...
func (m *MsgMallGoldFillReq) SetSoul(value int32) {
	if m != nil {
		if m.Soul != nil {
			*m.Soul = value
			return
		}
		m.Soul = proto.Int32(value)
	}
}

type MsgMallGoldFillRet struct {
	Retcode          *int32 `protobuf:"varint,1,req,name=retcode" json:"retcode,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MsgMallGoldFillRet) Reset()         { *m = MsgMallGoldFillRet{} }
func (m *MsgMallGoldFillRet) String() string { return proto.CompactTextString(m) }
func (*MsgMallGoldFillRet) ProtoMessage()    {}

func (m *MsgMallGoldFillRet) GetRetcode() int32 {
	if m != nil && m.Retcode != nil {
		return *m.Retcode
	}
	return 0
...
func (m *MsgMallGoldFillRet) SetRetcode(value int32) {
	if m != nil {
		if m.Retcode != nil {
			*m.Retcode = value
			return
