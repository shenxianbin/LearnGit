...
type IRole interface {
	...
	AddVip(vip_timestamp int64, is_notify bool, is_save bool)
	IsVip() bool

	CostChatFreeTime(is_notify bool, is_save bool) bool

	SetNewPlayerGuideStep(step int32, is_save bool)
	GetNewPlayerGuideStep() int32
	GuidePlunderAward() common.RetCode
	GetLoginTime() int64
	AddRechargeRecord(item_id int32)
	GetRechargeRecord(item_id int32) int32
	GetRechargeRecordsMap() map[int32]int32
