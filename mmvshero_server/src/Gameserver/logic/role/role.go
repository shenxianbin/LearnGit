...
func CreateRole(uid int64) (*Role, error) {
	...
	obj.RoleCache.SetRechargeRecord(make(map[int32]int32))
...
func (this *Role) LoadAllInfo(roleBytes []byte) error {
	...
	if this.RoleCache.RechargeRecord == nil {
		this.RoleCache.RechargeRecord = make(map[int32]int32)
	}
...
func (this *Role) AddVip(vip_timestamp int64, is_notify bool, is_save bool) {
	if vip_timestamp <= 0 {
		return
	}

	this.RoleCache.SetVip(this.RoleCache.GetVip() + vip_timestamp)
...
func (this *Role) AddRechargeRecord(item_id int32) {
	if _, has := this.RoleCache.RechargeRecord[item_id]; has {
		this.RoleCache.RechargeRecord[item_id]++
	} else {
		this.RoleCache.RechargeRecord[item_id] = 1
	}
	this.Save()
}

func (this *Role) GetRechargeRecord(item_id int32) int32 {
	if value, has := this.RoleCache.RechargeRecord[item_id]; has {
		return value
	}
	return 0
}

func (this *Role) GetRechargeRecordsMap() map[int32]int32 {
	return this.RoleCache.RechargeRecord
}
